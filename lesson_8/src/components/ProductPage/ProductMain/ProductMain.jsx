    ...
    return (
        <main className="main-product">
            ...
            <div className="main-product__img">
                ...
                <div className="main-product__img__img"><img src="./../../../src/images/main-product.jpg" alt="product" /></div>
                ...
                <section className="main-product__center center">
                    <div className="main-product__info">
                        ...
                        <p className="main-product__info__text">Compellingly actualize fully researched processes before proactive
                            outsourcing.<br />
                        ...
                        <button className="main-product__info__button"> <svg width="27" height="25" viewBox="0 0 27 25" fill="none"
                    ...
                    <div className="main-product__bottom__items">
                            ...
                            <div className="product__picturebox">
                                ...
                                <div className="product__picturebox__itemHover">
                                    <button className="product__picturebox__buy-button">
                                        <img src="./../../../src/images/vector.svg" alt="box"
                                            className="product__picturebox__buy-button-img" />
                                        Add to Cart
                                    </button>
                                </div>

                                <img src="./../../../src/images/main-product__bottom001.jpg" alt="photo 001"
                                    className="product__picturebox__img" />

                            </div>

                            <div className="product__content">
                                <h5 className="product__content__heading">ELLERY X M'O CAPSULE</h5>
                                <p className="product__content__text">Known for her sculptural takes on traditional <br />
                        ...
                        <div className="product">
                            ...
                            <div className="product__picturebox">
                                ...
                                <img src="./../../../src/images/main-product__bottom002.jpg" alt="photo 002"
                                    className="product__picturebox__img" />
                        ...
                        <div className="product">
                            ...
                            <div className="product__picturebox">
                                ...
                                <img src="./../../../src/images/main-product__bottom003.jpg" alt="photo 003"
                                    className="product__picturebox__img" />
